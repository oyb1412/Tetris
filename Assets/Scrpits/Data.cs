...
{
    #region 각 블록의 셀 정보
    public static readonly Dictionary<BlockType, Vector2Int[]> Cells = new Dictionary<BlockType, Vector2Int[]>()
    {
    ...
    #region J,L,O,S,T,Z모양 블록의 회전 정보
    ...
    #endregion
    public static readonly Dictionary<BlockType, Vector2Int[,]> WallKicks = new Dictionary<BlockType, Vector2Int[,]>()
    {
